...
strike you as either similar to or different from Python.
  ...
  1. the {} in Java which is not used in Python
  2. the public static void main?
  3. explicit boolean statement in Java 
  4. similar for loop but a little bit different
  5. the system.out and print in which is not used in Python
